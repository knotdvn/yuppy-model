<div class="report-section">
                <h1>Modeling Yuppy</h1>
                    <section>
                    <p>As I model yuppy, I begin by modeling individual data points. The rate which Amazon pays to yuppy is different according to category. Modeling these rates allow us to target yuppy to potential higher-yield payouts.</p>
                    ...
                    <h3>Analyze:</h3>
                    <p>This traffic data was generated pseudorandomly from very simple heuristics that keeps each month close to the other. This simulates a site with a consistent amount of steady visitors. The magicX (rate at which [Visitors] become [Customers]) is set to 500/1000 or .5 or 50%. I would very much love to operate a yuppy with a magicX of 500; however, what creates a high magicX is very much a mystery and is not the target of this report. My opinions on this matter are irrelevant compared to good A/B testing and extensive market research data.</p>
                    <br>
                    ...
                    <p>With this in mind, we see categories with lots of $0.00 items; MP3, Game Downloads, and Grocery are all very low. Electronics and Industrial have high priced products in their repetoire. Scrolling up, we remember that Electronics has half the payout rate of Industrial. Electronics might well indeed be an excellent target of a successful yuppy.</p>
                    ...
                    <h2>Profitability</h2>
                    <p>Ok, let's find out if any of this yuppy effort is worth it. Running a yuppy site is not free. Paying technical staff, bandwidth, name registration, and advertising are all likely costs to yuppy operation.</p>
                    <p>Below I'll ask you, potential yuppy operator, to enter in the number of monthly users you have or expect to have on your site. Let's limit this to 10,000 maximum for purposes of academic exercise.</p>
