                ...
                <h1>Methods and Design</h1>
                    <section>
                        ...
                        <ul>
                        	...
                        	<li>Product Data: This is a list of the 10 most popular products from a variety of Amazon categories. The name, price, and picture are important for this excercise.</li>
...
<p> With authentication keys from Amazon and effective use of the ApaiIO library, writing some php code yields our data. 
...
<p>That raw data is rather cumbersome; the response for ten items from a single category yields 3,000 lines of xml data. A sample request is available <a target="new" href="https://github.com/knotdvn/yuppy-model/blob/master/data/sample-raw-request.xml">in the project repo here</a>. Parsed out to a single item gives us <a target="new" href="https://github.com/knotdvn/yuppy-model/blob/master/data/sample-single-item.xml">this xml data</a>.</p>

<p>Of course this data is now written out to our <a target="new" href="https://github.com/knotdvn/yuppy-model/tree/master/model/_stuff/charts/catdata">catdata directory</a> in a format that can be manipulated by front end browser code.</p>

<h2>Modeling Tools</h2>

<p>From my perspective, <a target="new" href="http://www.highcharts.com/">HighCharts</a> is the best open-source and free for non-commercial use software to render resizable charts in a web browser. The <a target="new" href="http://api.highcharts.com/highcharts">HighCharts API</a> is extensive and useful. The <a target="new" href="https://github.com/highslide-software/highcharts.com/tree/master/samples/highcharts/demo"> demo examples</a> provide simple guidelines for quick execution.</p>
...
function revenueChart () {
    ...
    <p><a target="new" href="https://github.com">GitHub</a> for programmers is currently the end-all be-all for managing projects. My repo is available at <a target="new" href="https://github.com/knotdvn/yuppy-model">this location</a>. Utilizing the github paradigm provides for local to the machine and cloud copies of the source code. Additionally, the entire version history is preserved by the git protocol. This allows you to roll back through each step in the project and provides the <a target="new" href="https://github.com/knotdvn/yuppy-model/graphs/contributors">timeline of progress</a>.</p>
